<template>
  <div class="lesson-list">
    ...
    <div v-for="lesson in filteredLessons" :key="lesson.id" class="lesson-item">
      ...
      <div class="btn-group mt-2 ms-3">
        <button @click="editLesson(lesson)" class="btn btn-warning">Edit</button>
...
export default {
  ...
  methods: {
    editLesson(lesson) {
      this.$router.push({ name: 'EditLesson', params: { id: lesson.id } })
    },
    deleteLesson(lessonId) {
      this.$emit('delete-lesson', lessonId)
    }
  }
}
</script>
